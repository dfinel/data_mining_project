...
def get_all_infos_with_user_parameters():
    ...
    parser.add_argument('-all','--scrape_everything',type = str,choices = ('yes','no'),help = 'Whether to scrape everything or not')
    ...
    parser.add_argument('-cd','--create_database', type=str, choices=('yes','no'), default=None, help = 'Create database if specified, otherwise skip')
